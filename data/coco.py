...
class COCODetection(data.Dataset):
    ...
    def image_path_from_index(self, name, index):
        ...
        image_path = os.path.join(self.root, 'Images', index)
    ...
    def _get_ann_file(self, name):
        prefix = 'juggdet_0503'
        #     else 'image_info'
        return os.path.join(self.root, 'Lists', 'annotations',
                            prefix + '_' + name + '.json')
    ...
    def _annotation_from_index(self, index, _COCO):
        ...
        """
        im_ann = _COCO.loadImgs(index if type(index) == int else [index])[0]
        width = im_ann['width']
...
class COCOJuggdet(data.Dataset):
    """VOC Detection Dataset Object
